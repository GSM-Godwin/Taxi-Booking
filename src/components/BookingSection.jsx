...
const BookingSection = ({ errors, setErrors }) => {
    ...
    useEffect(() => {
        const ayamonteBounds = new window.google.maps.LatLngBounds(
            new window.google.maps.LatLng(37.2091, -7.4329),
            new window.google.maps.LatLng(37.2561, -7.3781)
        );

        // Initialize the autocomplete for the pickup input field
        const pickupAutocomplete = new window.google.maps.places.Autocomplete(pickupInputRef.current, {
            bounds: ayamonteBounds,
        ...
        const map = new window.google.maps.Map(mapRef.current, {
            center: { lat: 37.237, lng: -7.405 }, // Center of Ayamonte
